...
///////        ep.setText("html code");
        ...
        rules_panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, new Color(0, 0, 0)), "Regole della Community", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 0, 14))); // NOI18N
       ...
       GroupLayout rules_panelLayout = new GroupLayout(rules_panel);
        ...
        rules_panelLayout.setHorizontalGroup(
            rules_panelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        rules_panelLayout.setVerticalGroup(
            rules_panelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, rules_panelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        markups_panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, new Color(0, 0, 0)), "Tips", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 0, 14))); // NOI18N
        ...
        markups_panelLayout.setHorizontalGroup(
            markups_panelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
